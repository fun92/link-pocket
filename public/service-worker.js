const CACHE = 'link-pocket-shell-v5';
const SHELL = ['/', '/index.html', '/styles.css', '/mobile-fixes.css', '/app.js', '/manifest.webmanifest', '/icons/icon-180.png', '/icons/icon-192.png', '/icons/icon-512.png'];
